...
@Component({    
    templateUrl: './application/components/ratingProfile/editRatingProfile.html',
    directives: [CORE_DIRECTIVES, FORM_DIRECTIVES, FormInput, NgClass, EntitySummary, EntityDropdown, TAB_DIRECTIVES],
    pipes: [JsonPipe]
})
export class EditRatingProfile extends CRUDController {
    ...
    protected afterSave(sender: EditRatingProfile, data: any) {
