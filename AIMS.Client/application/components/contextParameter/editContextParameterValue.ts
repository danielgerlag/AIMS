...
@Component({
    selector: 'contextParameterValue',
})
@View({
    templateUrl: './application/components/contextParameter/editContextParameterValue.html',
    directives: [CORE_DIRECTIVES, FORM_DIRECTIVES, NgClass, TAB_DIRECTIVES, EntityDropdown, FormInput, DateInput, PublicSelector, NumericInput]
})
export class EditContextParameterValue implements OnInit, ICustomModalComponent {
