...
@Component({    
    templateUrl: './application/components/sequenceNumber/editSequenceNumber.html',
    directives: [CORE_DIRECTIVES, FORM_DIRECTIVES, FormInput, NgClass, EntitySummary, EntityDropdown, TAB_DIRECTIVES],
    pipes: [JsonPipe]
})
export class EditSequenceNumber extends CRUDController {
    ...
    protected afterSave(sender: EditSequenceNumber, data: any) {
