...
using AIMS.Services.Indexer.Store;
using System;
...
namespace AIMS.Services.Indexer
{
    public class SearchService : ISearchService
    {
        ...
        public List<T> SearchEntity<T>(string searchString, IDbContext dataContext, IEnumerable<string> include, int? dataAreaID = null)
        ...
        public IQueryable<EntityIndex> PrepareSearchQuery(string searchString, int? dataAreaID = null)
        {
            IQueryable<EntityIndex> query = _store.EntityIndexes.AsQueryable();
            if (dataAreaID != null)
            {
        ...
        public List<string> GetSearchSuggestions(string searchString, int? dataAreaID = null)
        {
            ...
            if (searchString.Length > 1)
            {
                ...
                if (dataAreaID != null)
                {
                    query = query.Where(x => x.EntityIndex.DataAreaID == dataAreaID);
                }
